...
if __name__ == '__main__':
    ...
    file_train = torch.load(TRAIN_PATH).permute(0,2,3,1)
    file_test = torch.load(TEST_PATH).permute(0,2,3,1)
        ...
        for ep in range(epochs):
            ...
            with torch.no_grad():
                ...
                if test_mse < best_test_mse:
                    ...
                    torch.save(model.state_dict(), '/wanghaixin/Cell_Division/ckpt/Best_FNO_wet_{}.pth'.format(args.k))
