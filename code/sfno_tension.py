...
def parse_args():
    ...
    parser.add_argument('--k', type=int, default=9, help='Number of steps for k-step prediction')
        ...
        for ep in range(epochs):
            ...
            with torch.no_grad():
                ...
                if test_mse < best_test_mse:
                    ...
                    torch.save(model.state_dict(), '/wanghaixin/Cell_Division/ckpt/Best_SFNO_tension_{}.pth'.format(args.k))
