...
if __name__ == '__main__':
    ...
    file_train = load_data(TRAIN_PATH)[0].view(ntrain, -1, 32, 32).permute(0, 2, 3, 1)  # 500, 21, 2, 32, 32
    file_test = load_data(TEST_PATH)[0].view(ntest, -1, 32, 32).permute(0, 2, 3, 1)  # 500, 21, 2, 32, 32
        ...
        for ep in range(epochs):
            ...
            with torch.no_grad():
                ...
                if test_mse < best_test_mse:
                    ...
                    torch.save(model.state_dict(), '/wanghaixin/Cell_Division/ckpt/Best_FNO_jelly_{}.pth'.format(args.k))
